...
function autostart.run()
  ...
  awful.spawn.with_shell("/usr/bin/fcitx")
  awful.spawn.with_shell("xcompmgr")
  --awful.spawn.with_shell("sleep 0.5 && xrandr --output DP-2 --auto --output DP-0 --auto --panning 3840x2160+3840+0 --scale 2x1.8 --right-of DP-2")
